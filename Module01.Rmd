...
As with the barchart, we want to modify the basic hist() function to add or change features of the polot Again, pay attention to the comments in the code below to understand what each additional argument does.

```{r}
hist(MLB$salary, # The first bit tells R which variable to graph
